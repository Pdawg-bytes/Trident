...
namespace Trident.CodeGeneration.Helpers;
    ...
    where T : IEquatable<T>
{
    ...
    public override unsafe int GetHashCode()
    {
        ...
        // Normally, if T == typeof(byte), we'd use HashCode.AddBytes(ReadOnlySpan<byte>)
        // However, Microsoft.Bcl.HashCode doesn't have this method for some odd reason.
