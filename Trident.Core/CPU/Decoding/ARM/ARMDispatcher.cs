    ...
    internal sealed class ARMDispatcher<TBus> where TBus : struct, IDataBus
    {
        ...
        private void InitPatterns(ARM7TDMI<TBus> cpu)
        {
            ...
            [
                ...
                new(mask: SWP_MASK,          expected: SWP_EXPECTED,          handler: cpu.ARM_Swap),
                ...
                new(mask: BX_MASK,           expected: BX_EXPECTED,           handler: cpu.ARM_BranchExchange),
                ...
                new(mask: UNDEFINED_MASK,    expected: UNDEFINED_EXPECTED,    handler: cpu.ARM_Undefined),
                ...
                new(mask: B_BL_MASK,         expected: B_BL_EXPECTED,         handler: cpu.ARM_BranchWithLink),
                ...
                new(mask: SWI_MASK,          expected: SWI_EXPECTED,          handler: cpu.ARM_SoftwareInterrupt),
            ];
        }
